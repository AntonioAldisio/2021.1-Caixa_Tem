...
<table class="tg">
    <thead>
        <tr>
            <th colspan="2" rowspan="2"> US09 - Eu como usuário do aplicativo desejo consultar o benefício Meu Nis.</th>
        </tr>        
    </thead>
</table>
...
<table class="tg">
    ...
    <tbody>
        <tr>
            <td>Cadastro Nis já efetuado.</td>
            <td>
                <ul>
                    <li>Usuário realizou previamente o cadastro do Nis. - <span style="color:green">OK</span></li>
                    <li>Usuário não tem cadastrio no Nis. - <span style="color:red">ERRO</span></li>
                </ul>
            </td>
            <td>
                <ul>
                    <li>Há erro no cadastro do Nis?</li>
                </ul>
            </td>
        </tr>
        <tr>
