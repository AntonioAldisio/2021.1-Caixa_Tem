...
<table class="tg">
    <thead>
        <tr>
            <th colspan="2" rowspan="2"> US020 - Eu como usuário do aplicativo desejo realizar pagamento maquininha com QR Code.</th>
        </tr>        
    </thead>
</table>
...
<table class="tg">
    ...
    <tbody>
        ...
        <tr>
            <td>Possuir o QR Code de pagamento.</td>
            <td>
                <ul>
                    <li>O usuário tem o QR Code de pagamento.- <span style="color:green">OK</span></li>
                    <li>O usuário não conseguiu o QR Code de pagamento.  - <span style="color:red">ERRO</span></li>
                </ul>
            </td>
            <td>
                <ul>
