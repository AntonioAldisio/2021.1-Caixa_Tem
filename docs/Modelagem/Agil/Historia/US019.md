...
<table class="tg">
    <thead>
        <tr>
            <th colspan="2" rowspan="2"> US019 - Eu como usuário do aplicativo desejo realizar pagamento em qualquer Unidades Lotéricas.</th>
        </tr>        
    </thead>
</table>
...
<table class="tg">
    ...
    <tbody>
        ...
        <tr>
            <td>Gerar um código de pagamento.</td>
            <td>
                <ul>
                    <li>O usuário gerou o código pelo aplictivo. - <span style="color:green">OK</span></li>
                    <li>O usuário não sabe o número do código.  - <span style="color:red">ERRO</span></li>
                </ul>
            </td>
            <td>
                <ul>
