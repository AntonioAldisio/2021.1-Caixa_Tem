...
<table class="tg">
    <thead>
        <tr>
            <th colspan="2" rowspan="2"> US15 - Eu como usuário do aplicativo desejo realizar pagamento via  PIX.</th>
        </tr>        
    </thead>
</table>
...
<table class="tg">
    ...
    <tbody>
        ...
        <tr>
            <td>Ter realizado cadastro de pelo menos uma chave PIX no banco CAIXA.</td>
            <td>
                <ul>
                    <li>Ter cadastrado uma chave pix previamente. - <span style="color:green">OK</span></li>
                    <li>Não ter chave pix cadatrada no banco.  - <span style="color:red">ERRO</span></li>
                </ul>
            </td>
            <td>
                <ul>
