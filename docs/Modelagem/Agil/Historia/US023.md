...
<table class="tg">
    <thead>
        <tr>
            <th colspan="2" rowspan="2"> US023 - Eu como usuário do aplicativo desejo realizar recarga de cartão de transporte.</th>
        </tr>        
    </thead>
</table>
...
<table class="tg">
    ...
    <tbody>
        ...
        <tr>
            <td>Possuir um cartão transporte.</td>
            <td>
                <ul>
                    <li>O usuário já tem um cartão transporte. - <span style="color:green">OK</span></li>
                    <li>O usuário não tem cartão transporte de destino.  - <span style="color:red">ERRO</span></li>
                </ul>
            </td>
            <td>
                <ul>
