...
<table class="tg">
    <thead>
        <tr>
            <th colspan="2" rowspan="2"> US018 - Eu como usuário do aplicativo desejo realizar pagamento via boleto.</th>
        </tr>        
    </thead>
</table>
...
<table class="tg">
    ...
    <tbody>
        ...
        <tr>
            <td>Ter o documento impresso o numéro de código em mãos.</td>
            <td>
                <ul>
                    <li>O usuário tem o número do boleto. - <span style="color:green">OK</span></li>
                    <li>O usuário não sabe o número do boleto.  - <span style="color:red">ERRO</span></li>
                </ul>
            </td>
            <td>
                <ul>
