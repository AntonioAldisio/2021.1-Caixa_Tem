...
<table class="tg">
    <thead>
        <tr>
            <th colspan="2" rowspan="2"> US024 - Eu como usuário do aplicativo desejo realizar recarga de telefone. </th>
        </tr>        
    </thead>
</table>
...
<table class="tg">
    ...
    <tbody>
        ...
        <tr>
            <td>Possuir número para recarga.</td>
            <td>
                <ul>
                    <li>O usuário já tem um número de destino. - <span style="color:green">OK</span></li>
                    <li>O usuário não tem um número de destino.  - <span style="color:red">ERRO</span></li>
                </ul>
            </td>
            <td>
                <ul>
