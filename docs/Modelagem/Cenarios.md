...
<p style="text-indent: 40px; align="justify">Cada cenário descreve, através de linguagem natural semi-estruturada, uma situação específica de uma aplicação de software, priorizando seu comportamento.<a href="../Cenarios#Bibliografia">[1]</a><br></p>
...
| **Recursos**| <ul><li><a href="../Cenarios#cadastro">Conta no aplicativo</a></li></ul> |
...
| **Restrição**| <ul><li>Usuário deve possuir <a href="../Cenarios#cadastro">cadastro.</a></li></ul> |
...
| <br>**Contexto**|<ul><li>Local - Tela de lista de funcionalidades.</li><li>Tempo - A qualquer momento.</li><li>Pré-condições - Usuário deve estar <a href="../Cenarios#login">logado</a>.</li></ul>|
| **Atores**| <ul><li>Usuário</li><li>Sistema.</li></ul> |
| **Recursos**| <ul><li><a href="../Cenarios#cadastro">Conta no aplicativo</a>.</li></ul> |
| **Episódios**| <ul><li>Usuário seleciona a funcionalidade de extrato.</li><li>Usuário seleciona o período desejado.</li></ul> |
| **Restrição**| <ul><li>Usuário deve possuir <a href="../Cenarios#cadastro">cadastro.</a></li><li>Usuário deve estar <a href="../Cenarios#login">logado</a>.</li></ul> |
...
| <br><br>**Contexto**|<ul><li>Local - Tela de lista de funcionalidades.</li><li>Tempo - A qualquer momento.</li><li>Pré-condições - Usuário deve estar <a href="../Cenarios#login">logado</a>.</li></ul>|
| **Atores**| <ul><li>Usuário</li><li>Sistema.</li></ul> |
| **Recursos**| <ul><li><a href="../Cenarios#cadastro">Conta no aplicativo</a>.</li></ul> |
...
| <br>**Contexto**|<ul><li>Local - Tela de lista de funcionalidades.</li><li>Tempo - A qualquer momento.</li><li>Pré-condições - Usuário deve estar <a href="../Cenarios#login">logado</a>.</li></ul>|
| **Atores**| <ul><li>Usuário</li><li>Sistema.</li></ul> |
| <br>**Recursos**| <ul><li><a href="../Cenarios#cadastro">Conta no aplicativo</a>.</li><li>Elegibilidade para programa social.</li><li>NIS</li></ul> |
| **Episódios**| <ul><li>Usuário escolhe o programa social desejado.</li></ul> |
| **Restrição**| <ul><li>Usuário deve estar <a href="../Cenarios#login">logado</a>.</li><li>Usuário deve ser elegível para o benefício social.</li></ul> |
...
| **Restrição**| <ul><li>Usuário deve estar <a href="../Cenarios#login">logado</a>.</li><li>Usuário deve possuir uma transação executada previamente.</li></ul> |
| **Exceção**| <ul><li>Não ter acesso à internet.</li><li>Smartphone descarregado.</li></ul> |
...
| <br>**Contexto**|<ul><li>Local - Tela de lista de funcionalidades.</li><li>Tempo - A qualquer momento.</li><li>Pré-condições - Usuário deve estar <a href="../Cenarios#login">logado</a>.</li></ul>|
| **Atores**| <ul><li>Usuário</li><li>Sistema.</li></ul> |
| <br>**Recursos**| <ul><li><a href="../Cenarios#cadastro">Conta no aplicativo</a></li><li>Linha telefônica Pré-paga.</li><li><a href="../Cenarios#saldo">Saldo</a> disponível na conta do aplicativo.</li></ul> |
...
| **Restrição**| <ul><li>Usuário deve estar <a href="../Cenarios#login">logado</a>.</li><li>Usuário deve possuir <a href="../Cenarios#saldo">saldo</a> suficiente para a transação.</li></ul> |
| <br><br>**Exceção**| <ul><li>Não ter acesso à internet.</li><li>Smartphone descarregado.</li><li>Preenchimento de dados incorreta.</li><li><a href="../Cenarios#saldo">Saldo</a> insuficiente.</li></ul> |
...
### C09: Consultar Saldo <a id="saldo"></a>
...
| **Restrição**| <ul><li>O usuário deve possuir <a href="../Cenarios#cadastro">cadastro.</a></li></ul> |
| **Exceção**| <ul><li>Não ter acesso à internet.</li><li>Smartphone descarregado.</li></ul> |
...
| **Restrição**| <ul><li>O usuário deve possuir <a href="../Cenarios#cadastro">cadastro.</a></li><li>O usuário deve possuir <a href="../Cenarios#saldo">dinheiro na conta</a></li></ul> |
...
| **Restrição**| <ul><li>O usuário deve possuir <a href="../Cenarios#cadastro">cadastro.</a></li><li>O usuário deve possuir <a href="../Cenarios#saldo">dinheiro na conta</a>.</li><li>O usuário deve possuir um cartão de transporte.</li></ul> |
| **Exceção**| <ul><li>Não ter acesso à internet.</li><li>Smartphone descarregado.</li></ul> |
...
| **Restrição**| <ul><li>O usuário deve possuir <a href="../Cenarios#cadastro">cadastro.</a></li><li>O usuário deve possuir <a href="../Cenarios#saldo">dinheiro suficiente</a> para contratar o seguro.</li></ul> |
...
| **Restrição**| <ul><li>O usuário deve possuir <a href="../Cenarios#cadastro">cadastro.</a></li><li>O usuário deve possuir o código de barras da conta.</li></ul> |
...
| **Restrição**| <ul><li>O usuário deve possuir <a href="../Cenarios#cadastro">cadastro.</a></li><li>O usuário deve possuir uma chave pix cadastrada.</li></ul> |
| **Exceção**| <ul><li>Não ter acesso à internet.</li><li>Smartphone descarregado.</li></ul> |
