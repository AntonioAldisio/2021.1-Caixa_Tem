...
<p style="text-indent: 40px; align="justify"> Cenários são descrições de situações comuns ao cotidiano e que devem levar em <a href="../Lexicos#Conta">conta</a> os aspectos de usabilidade e permitir o aprofundamento do conhecimento do problema, a unificação de critérios, a obtenção do compromisso de clientes e/ou usuários, a organização de detalhes e o treinamento de pessoas.</p>
<p style="text-indent: 40px; align="justify">Cada cenário descreve, através de linguagem natural semi-estruturada, uma situação específica de uma aplicação de software, priorizando seu comportamento.<a href="../Lexicos#Bibliografia">[1]</a><br></p>
...
| **Título**| Cadastro |
|--|--|
| **Objetivo**| <ul><li>Criar <a href="../Lexicos#Conta">conta</a> de usuário.</li></ul> |
...
| <br>**Contexto**|<ul><li>Local - Tela inicial do aplicativo.</li><li>Tempo - A qualquer momento.</li><li>Pré-condições - Usuário não pode estar <a href="../Lexicos#Login">Logado</a> do aplicativo.<br></li></ul>|
...
| **Restrição**| <ul><li>Usuário deve possuir <a href="../Lexicos#Conta">cadastro.</a></li></ul> |
...
| <br>**Contexto**|<ul><li>Local - Tela de lista de funcionalidades.</li><li>Tempo - A qualquer momento.</li><li>Pré-condições - Usuário deve estar <a href="../Lexicos#login">logado</a>.</li></ul>|
| **Atores**| <ul><li>Usuário</li><li>Sistema.</li></ul> |
| **Recursos**| <ul><li><a href="../Lexicos#Conta">Conta no aplicativo</a>.</li></ul> |
| **Episódios**| <ul><li>Usuário seleciona a funcionalidade de <a href="../Lexicos#Extrato">extrato</a>.</li><li>Usuário seleciona o período desejado.</li></ul> |
| **Restrição**| <ul><li>Usuário deve possuir <a href="../Lexicos#Conta">cadastro.</a></li><li>Usuário deve estar <a href="../Lexicos#login">logado</a>.</li></ul> |
...
| **Atores**| <ul><li>Usuário</li><li>Sistema.</li></ul> |
| **Recursos**| <ul><li><a href="../Lexicos#Conta">Conta no aplicativo</a></li></ul> |
| **Episódios**| <ul><li>Usuário seleciona a opção de <a href="../Lexicos#Transferir">transferência</a>.</li><li>Usuário escolhe a opção Ver calendário.</li></ul> |
| **Restrição**| <ul><li>Usuário deve possuir <a href="../Lexicos#Conta">cadastro.</a></li><li>Usuário deve estar <a href="../Lexicos#login">logado</a>.</li></ul> |
| **Exceção**| <ul><li>Não ter acesso à internet.</li><li>Smartphone descarregado.</li></ul> |
...
| <br><br>**Contexto**|<ul><li>Local - Tela de lista de funcionalidades.</li><li>Tempo - A qualquer momento.</li><li>Pré-condições - Usuário deve estar <a href="../Lexicos#login">logado</a>.</li></ul>|
| **Atores**| <ul><li>Usuário</li><li>Sistema.</li></ul> |
| **Recursos**| <ul><li><a href="../Lexicos#Conta">Conta no aplicativo</a>.</li></ul> |
| **Episódios**| <ul><li>Usuário escole a opção Informe de <a href="../Lexicos#Rendimento">rendimentos</a>.</li><li>Usuário seleciona Ver informe de <a href="../Lexicos#Rendimento">rendimentos</a></li></ul> |
| **Restrição**| <ul><li>Usuário deve possuir <a href="../Lexicos#Conta">cadastro.</a></li><li>Usuário deve estar <a href="../Lexicos#login">logado</a>.</li></ul> |
| **Exceção**| <ul><li>Não ter acesso à internet.</li><li>Smartphone descarregado.</li></ul> |
...
| **Restrição**| <ul><li>Usuário deve estar <a href="../Lexicos#login">logado</a>.</li><li>Usuário deve ser elegível para o benefício social.</li></ul> |
...
| **Atores**| <ul><li>Usuário</li><li>Sistema.</li></ul> |
| **Recursos**| <ul><li><a href="../Lexicos#Conta">Conta no aplicativo</a></li></ul> |
| <br>**Episódios**| <ul><li>Usuário escolhe a opção de <a href="../Lexicos#Comprovante">comprovantes</a></li><li>Usuário seleciona o período em que a operação foi realizada</li><li>Usuário escolhe a transação procurada.</li></ul> |
| **Restrição**| <ul><li>Usuário deve estar <a href="../Lexicos#login">logado</a>.</li><li>Usuário deve possuir uma transação executada previamente.</li></ul> |
| **Exceção**| <ul><li>Não ter acesso à internet.</li><li>Smartphone descarregado.</li></ul> |
...
| **Restrição**| <ul><li>Usuário deve estar <a href="../Lexicos#login">logado</a>.</li><li>Usuário deve possuir <a href="../Lexicos#Saldo">saldo</a> suficiente para a transação.</li></ul> |
...
| **Restrição**| <ul><li>O usuário deve possuir <a href="../Lexicos#Conta">cadastro.</a></li></ul> |
| **Exceção**| <ul><li>Não ter acesso à internet.</li><li>Smartphone descarregado.</li></ul> |
...
| <br>**Contexto**|<ul><li>Local - Tela de lista de funcionalidades</li><li>Tempo - A qualquer momento</li><li>Pré-condições - Possuir o app CaixaTem.</li></ul>|
| **Atores**| <ul><li>Usuário</li><li>Sistema</li><li>Outra <a href="../Lexicos#Conta">Conta</a></li></ul> |
| **Recursos**| <ul><li>Acesso à internet.</li><li>Aplicativo instalado.</li></ul> |
...
| **Restrição**| <ul><li>O usuário deve possuir <a href="../Lexicos#Conta">cadastro.</a></li><li>O usuário deve possuir <a href="../Lexicos#Saldo">saldo</a> na <a href="../Lexicos#Conta">conta</a></li></ul> |
...
| **Restrição**| <ul><li>O usuário deve possuir <a href="../Lexicos#Conta">cadastro.</a></li><li>O usuário deve possuir <a href="../Lexicos#Saldo">saldo</a> na <a href="..Lexicos#Conta">conta</a></a>.</li><li>O usuário deve possuir um cartão de transporte.</li></ul> |
| **Exceção**| <ul><li>Não ter acesso à internet.</li><li>Smartphone descarregado.</li></ul> |
...
| **Restrição**| <ul><li>O usuário deve possuir <a href="../Lexicos#Conta">cadastro.</a></li><li>O usuário deve possuir <a href="../Lexicos#Saldo">saldo</a> suficiente para contratar o <a href="../Lexicos#Seguro">seguro</a>.</li></ul> |
...
|--|--|
| **Objetivo**| <ul><li>Gerar um código para o usuário pagar <a href="../Lexicos#Conta">conta</a>s na lotérica sem cartão.</li></ul> |
| <br>**Contexto**|<ul><li>Local - Tela de lista de funcionalidades</li><li>Tempo - A qualquer momento</li><li>Pré-condições - Possuir o app CaixaTem.</li></ul>|
| **Atores**| <ul><li>Usuário</li><li>Sistema</li></ul> |
| **Recursos**| <ul><li>Acesso à internet.</li><li>Aplicativo instalado.</li></ul> |
...
| **Restrição**| <ul><li>O usuário deve possuir <a href="../Lexicos#Conta">cadastro.</a></li><li>O usuário deve possuir o código de barras da <a href="../Lexicos#Conta">conta</a>.</li></ul> |
...
| **Restrição**| <ul><li>O usuário deve possuir <a href="../Lexicos#Conta">cadastro.</a></li><li>O usuário deve possuir uma chave <a href="../Lexicos#PIX">PIX</a> cadastrada.</li></ul> |
| **Exceção**| <ul><li>Não ter acesso à internet.</li><li>Smartphone descarregado.</li></ul> |
