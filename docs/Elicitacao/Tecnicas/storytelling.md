    ...
    <tbody>
        <tr">
            <td rowspan="7" colspan="5" style="width: 350px">
                <figure>
                    <center>
                    <img src="../../../assets/Personas/CarmenSouza.jpeg" height="175" width="175" alt="Foto de Jão Vitor"></img>
                    </center>
                    <figcaption>Figura 1: Foto de Carmen <br>Fonte: This Person Does Not Exist [2]
                    </figcaption>
                </figure>
            </td>
        </tr>
        <tr>
            ...
            <td class="persona" colspan="1">26 anos.</td>
        </tr>
        <tr>
            <td class="titulo"><strong>Ocupação:</strong></td>
            <td colspan="1">Desempregada.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="1" class="persona">Conseguir um emprego. <br>Dar boa vida para o filho.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="8" class="persona">Carmen tem facilidade com pintura, já estudou arte no passado, mas nunca conseguiu levar adiante. Tem bastante dificuldades com aparelhos eletrônicos e detesta redes sociais.</td>
        </tr>
        <tr>
            <td><strong>Tarefas:</strong></td>
            <td colspan=8 class="persona">Carmen acorda cedo para levar o filho na escola, depois de deixar o filho no colégio sai em busca de emprego, geralmente volta de tarde perto do anoitecer, que é quando precisa cuidar das tarefas de casa.</td>
        </tr>
        <tr>
            <td><strong>Requisitos:</strong></td>
            <td colspan=8 class="persona">Para Carmen, deve ter o minimo de passos possíveis, já que ela tem grande dificuldade com o manuseio de aparelhos, prefere que o processo seja o mais curto possível.</td>
        </tr>
        <tr>
            <td><strong>Expectativas:</strong></td>
            <td colspan=8 class="persona">Carmen precisa do auxilio dos programas sociais, então ela sempre entra no aplicativo com o intuito de pagar suas contas e sacar o dinheiro para comprar os alimentos para casa.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td class="titulo"><strong>Habilidades:</strong></td>
            <td colspan="8" class="persona">Não tem muito contato com dispositivos eletrônicos, gosta de trabalho manual, sente que pode entender melhor o que está fazendo se puder tocar no objeto em questão.</td>
        </tr>
        <tr>
            <td><strong>Tarefas:</strong></td>
            <td colspan=8 class="persona">Sempre acorda cedo, já que o trabalho exige sua pontualidade logo cedo, toma café da manhã e assiste o jornal matinal. Pega ônibus para chegar ao trabalho onde fica até o fim da tarde.</td>
        </tr>
        <tr>
            <td><strong>Requisitos:</strong></td>
            <td colspan=8 class="persona">Para João Vitor, um aplicativo deve ter as funcionalidades essenciais ser fácil de usar, já que ele não se dá bem com dispositivos eletrônicos, gostaria de que as funcionalidades fossem mais instrutivas.</td>
        </tr>
        <tr>
            <td><strong>Expectativas:</strong></td>
            <td colspan=8 class="persona">João Vitor espera poder fazer as suas transferências e pagamentos pelo aplicativo, sem necessitar pedir ajuda para os colegas e ou família.</td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        <tr">
            <td rowspan="7" colspan="5" style="width: 350px">
                <figure>
                    <center>
                    <img src="../../../assets/Personas/MariaClara.jpeg" height="175" width="175" alt="Foto de Jão Vitor"></img>
                    </center>
                    <figcaption>Figura 1: Foto de Maria Clara <br>Fonte: This Person Does Not Exist [2]
                    </figcaption>
                </figure>
            </td>
        </tr>
        ...
        <tr>
            <td class="titulo"><strong>Objetivos:</strong></td>
            <td colspan="1" class="persona">Deseja ser independente, se formar e exercer a profissão que escolheu, se tornar independente, sair com os amigos.</td>
        </tr>
        <tr>
            <td class="titulo"><strong>Relacionamentos:</strong></td>
        ...
        <tr>
            <td class="titulo"><strong>Habilidades:</strong></td>
            <td colspan="8" class="persona">Tem bastante experiencia com tecnologia, sempre está gravando e postando suas aventuras com os amigos nas redes sociais.</td>
        </tr>
        <tr>
            <td><strong>Tarefas:</strong></td>
            <td colspan=8 class="persona">Já acorda de olho na sua agenda, pois manejar os afazeres da faculdade exigem que Maria seja muito cuidadosa com seus horários e tarefas, já que mora com os pais Maria pode se focar em estudar para a faculdade, e sempre que tem tempo livre sai com os amigos.</td>
        </tr>
        <tr>
            <td><strong>Requisitos:</strong></td>
            <td colspan=8 class="persona">Para Maria, um aplicativo deve ter as funcionalidades essenciais para a realização de suas tarefas, Maria necessita que o aplicativo tenha as funcionalidades necessárias de forma que possa encontra-las com rapidez.</td>
        </tr>
<!--        <tr>
            <td><strong>Expectativas:</strong></td>
            <td colspan=8 class="persona"></td>
        </tr>-->
    </tbody>
</table>
