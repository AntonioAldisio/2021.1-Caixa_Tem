...
O presente documento visa verificar o artefato de <a href = "/2021.1-Caixa_Tem/docs/Modelagem/Agil/backlog.md">Backlog</a>, afim de procurar quaisquer erros no modelo em termos de notação, processo ou procedimentos no Backlog <a href="#Bibliografia">[1]</a></p>
</p>
...
<p style="text-indent: 40px; align="justify">
Após a realização da verificação, percebeu-se que, a tecnica foi utilizada corretamente e apresentado os devidos requitos para tal. Referências textuais,explicação não cometem para tal.
</p>
